...
{
    GLLighting& lighting = ui->glWindow->getLighting();
    QColor peek = QColorDialog::getColor(lighting.getAmbientColor(), nullptr, "Choose Light Ambient Color", QColorDialog::ShowAlphaChannel | QColorDialog::NoButtons);
...
{
    GLLighting& lighting = ui->glWindow->getLighting();
    QColor peek = QColorDialog::getColor(lighting.getDiffuseColor(), nullptr, "Choose Light Diffuse Color", QColorDialog::ShowAlphaChannel | QColorDialog::NoButtons);
...
{
    GLLighting& lighting = ui->glWindow->getLighting();
    QColor peek = QColorDialog::getColor(lighting.getSpecularColor(), nullptr, "Choose Light Specular Color", QColorDialog::ShowAlphaChannel | QColorDialog::NoButtons);
...
{
    std::shared_ptr<GLFigure> figure = ui->glWindow->getFigure(ui->figureSelector->value() - 1);
    QColor peek = QColorDialog::getColor(figure->getMaterial().getDiffuseColor(), nullptr, "Choose Material Diffuse Color", QColorDialog::ShowAlphaChannel | QColorDialog::NoButtons);
...
{
    std::shared_ptr<GLFigure> figure = ui->glWindow->getFigure(ui->figureSelector->value() - 1);
    QColor peek = QColorDialog::getColor(figure->getMaterial().getSpecularColor(), nullptr, "Choose Material Specular Color", QColorDialog::ShowAlphaChannel | QColorDialog::NoButtons);
